...
public class IotDeviceServiceImpl implements IIotDeviceService {
    ...
    public int controlDeviceByNum(String deviceNum, String cmd) {
        ...
        // iotDeviceStatusService.selectIotDeviceStatusByDeviceId(iotDeviceSet.getDeviceId());
        ...
        // //mqtt发布
        // IotDeviceSet set =
        // iotDeviceSetService.selectIotDeviceSetByDeviceId(iotDeviceSet.getDeviceId());
    ...
    public int bindDevice(Long userId, String nickName, String deviceNum, String name, Long categoryId, String remark) {
        ...
        Long deviceId = iotDevice.getDeviceId();
        IotDeviceUserRelation iotDeviceUserRelation = deviceUserRelationService
                .selectIotDeviceUserRelationByDeviceIdAndUserId(deviceId, userId);
    ...
    @Override
    public int updateDeviceEnable(Long deviceId, int enable) {
        return iotDeviceMapper.updateDeviceEnable(deviceId, enable);
    }
}
