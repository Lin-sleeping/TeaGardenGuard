...
<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="在线" align="center" prop="enable">
...
import { changeDeviceEnable } from '@/api/device'
...
export default {
  ...
  methods: {
    ...
    async changeEnable(row) {
      const oldValue = row.enable === 1 ? 0 : 1
      try {
        await changeDeviceEnable(row.deviceId, row.enable)
